...
`);
    ...
    // Đảm bảo cột payment_ref có kích thước đủ lớn để lưu link MoMo/PayOS dài
    await pool.query("ALTER TABLE dealer_upgrade_requests MODIFY COLUMN payment_ref VARCHAR(500) DEFAULT NULL")
